...
export default function Page() {
    ...
    return (
        <section>
            <div className="w-full h-[300px] flex justify-center items-center capitalize text-[30px] bg-center bg-cover text-[white] bg-back-classy">
